...
/**
 * @ClassName: ChangeLicenseImpl.java
 * @Description:购买属性：授权变更创建调拨
 * @author: fengzf fengzf@gstarcad.com
 * @Date: 2020/1/3 16:28
 *
 */
@Service("changeLicenseService")
public class ChangeLicenseServiceImpl implements RequisitionService {
    /**
     *创建调拨，返回调拨id，调拨编号
     * @return
     */
